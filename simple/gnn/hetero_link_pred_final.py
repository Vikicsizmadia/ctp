...
from evaluation_heterodata_GNN_model import accuracyGNN
from make_heterodata_final_GNN import DataParser
...
def train():
    ...
    scores_total.append(pred.shape[0])
    scores_bigger_09.append(int((pred > 0.9).sum()))
    scores_bigger_08.append(int((pred > 0.8).sum()))
    scores_bigger_07.append(int((pred > 0.7).sum()))
    scores_bigger_06.append(int((pred > 0.6).sum()))
    scores_bigger_05.append(int((pred > 0.5).sum()))
    scores_bigger_03.append(int((pred > 0.3).sum()))
    scores_smaller_01.append(int((pred < 0.1).sum()))
    scores_smaller_005.append(int((pred < 0.05).sum()))
    scores_smaller_001.append(int((pred < 0.01).sum()))
    scores_smaller_0005.append(int((pred < 0.005).sum()))
    scores_smaller_0001.append(int((pred < 0.001).sum()))
